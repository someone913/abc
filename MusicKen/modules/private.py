...
async def start_(client: Client, message: Message):
    await message.reply_sticker(
        "CAACAgUAAxkBAAFFVU9hBPPBdy0ix0H0ZxWH7HzSevUa9AADAwACcPO4VpG6Xut-2MmzIAQ"
    )
    await message.reply_text(
        f"""👋🏻 Hallo ges
🤖 Saya adalah bot canggih yang dibuat untuk memutar musik di obrolan suara Grup & Saluran Telegram.

✅ Kirim aku /help atau klik tombol bantuan untuk info lebih lanjut
""",
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton("👦 Own Bot", url=f"https://t.me/ebnudoang"),
                    InlineKeyboardButton(
